...
for code in codes:
    ...
    try:
        ...
        filePath ='C:\\Users\\lawrence\\Downloads\\'+ code +'_history.csv'
...
for code in codes:
    ...
    df = pd.read_csv('C:/Users/lawrence/Downloads/'+ code +'_history.csv')
    ...
    df.to_csv('C:/Users/lawrence/Desktop/Fintech/fintect proj/crawler/stk2/'+code+'.txt',sep='\t')
